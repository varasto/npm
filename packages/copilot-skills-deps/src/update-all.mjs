/**
 * Update-all command - Batch update all skills in repo
 */
...
/**
 * Update all skills in the repository
...
export function updateAll() {
  ...
  console.log(`Found ${packageJsons.length} skill(s) to update`);
  ...
  console.log(`\n${allSucceeded ? "✓" : "✗"} Update-all ${allSucceeded ? "completed" : "completed with errors"}`);
  return allSucceeded;
}
